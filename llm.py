...
def generate_draft_website(client_card_json):
...
- Use icons or visual indicators (CSS-only, like colored circles or borders)
...
def generate_draft_minisite(client_card_json):
...
6. "גלריה" (Gallery) — 3-4 placeholder image boxes with subtle overlay
